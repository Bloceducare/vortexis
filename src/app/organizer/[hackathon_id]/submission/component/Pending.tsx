...
const Pending: React.FC<SubmissionProps> = ({
  ...
  return (
    ...
    >
      ...
      <section>
        <table className="table-auto w-full mt-5 min-w-[600px]">
          <thead>
              ...
              filteredSubmissions.map((sub, index) => (
                ...
                >
                  ...
                  {selectedSubmission && (
                    ...
                    >
                      <div
                        className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 max-w-6xl relative max-h-[80vh] overflow-y-auto transition-colors"
                      ...
                      >
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-300 mb-4">
                          {showFull
                            ...
                            : `${selectedSubmission.project.description.slice(
                                0,
                                150
                              )}${
                                selectedSubmission.project.description.length >
                                150
                                  ? "..."
                                  : ""
                              }`}
        ...
        <div className="flex justify-between items-center mt-5 px-5">
          <p className="text-[#727272]">
            ...
            {pendingSubmissions.length} entries
          </p>
