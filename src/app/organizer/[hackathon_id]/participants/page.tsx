        ...
        >
          <div className="flex justify-between items-center px-5">
            ...
            <div className="flex items-center justify-between gap-5">
              <div className="flex items-center gap-3 rounded-lg px-3 py-2 bg-[#F9FBFF] dark:bg-gray-700 w-[55%] transition-colors">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              <div className="relative w-[90%]">
                <div
                  className="flex items-center justify-between bg-[#F9FBFF] dark:bg-gray-700 px-3 py-2 rounded-lg gap-4 cursor-pointer transition-colors"
                ...
                >
                  ...
                  <div className="flex justify-between items-center w-[70%]">
                    <span className="font-semibold text-sm text-[#212121] dark:text-white">
                ...
                {isDropdownOpen && (
                  <ul className="absolute left-0 right-0 z-10 mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg max-h-60 overflow-auto transition-colors">
                    <li
                      onClick={() => {
                        setSortOrder("");
                        setCurrentPage(1);
                      ...
                      className="px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer text-sm text-gray-700 dark:text-gray-300 transition-colors"
                    >
                      By country
                    </li>
          ...
          <section>
                  ...
                  filteredParticipants.map((sub, index) => (
                    ...
                    >
                      <td className="px-4 py-7">
                        <div>
                          <h1 className="text-[#212121] dark:text-white">
                            {sub.title}
                          </h1>
                        </div>
                      </td>
                      <td className="px-4 py-7 dark:text-gray-300">
                        {" "}
                        {sub.team}
                      </td>
                      <td className="px-4 py-7">
                      ...
                      <td className="px-2 py-7 text-[#292D32] dark:text-gray-300 font-medium">
                        {sub.country}
                      </td>
            ...
            <div className="flex justify-between items-center mt-5 px-5">
              ...
              <nav className="flex justify-center items-center gap-3 mt-5">
                <p
                  onClick={handlePrev}
                  className="border px-4 rounded-lg cursor-pointer bg-[#F5F5F5] dark:bg-gray-700 border-[#EEEEEE] dark:border-gray-600 py-2 text-[#404B52] dark:text-gray-300 font-semibold transition-colors"
                >
                  {"<"}
                </p>
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg ${
                          currentPage === index + 1
                            ...
                            : "bg-[#F5F5F5] dark:bg-gray-700 text-[#404B52] dark:text-gray-300 border border-[#EEEEEE] dark:border-gray-600 hover:bg-[#5932EA] hover:text-white transition-colors"
                        }`}
                      >
                        {index + 1}
                      </button>
