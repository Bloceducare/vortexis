...
import { Edit, Calendar, MapPin, Award, Users, FileText, Clock } from "lucide-react";
...
function Page() {
  ...
  return (
    <section className="w-full min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-500 text-sm font-medium mb-1">{stat.type}</p>
                    <h3 className="text-4xl font-bold text-gray-800">{stat.number || 0}</h3>
                  </div>
                  <div className={`${stat.color} p-4 rounded-xl group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 font-semibold">{formatDate(data?.start_date)}</p>
                    <p className="text-gray-600 text-sm">to {formatDate(data?.end_date)}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-gray-500 text-sm font-medium">Submission Deadline</p>
                    <p className="text-gray-800 font-semibold">{formatDate(data?.submission_deadline)}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-gray-500 text-sm font-medium">Venue</p>
                    <p className="text-gray-800 font-semibold">{data?.venue}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-gray-500 text-sm font-medium">Grand Prize</p>
                    <p className="text-gray-800 font-semibold">₦{data?.grand_prize?.toLocaleString()}</p>
                  </div>
                </div>
            ...
            {data?.prizes && (
              <div className="bg-white rounded-2xl p-6 shadow-md">
                <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                  <Award className="text-[#605DEC]" size={24} />
                  Other Prizes
                </h2>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md">
              <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <FileText className="text-[#605DEC]" size={24} />
                Rules & Guidelines
              </h2>
          ...
          >
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md">
              <div className="w-full aspect-square rounded-xl overflow-hidden mb-4 bg-gradient-to-br from-purple-100 to-blue-100">
                <Image src={data?.banner || Hacks} alt="hackathon" className="w-full h-full object-cover" />
              </div>
            ...
            {data?.judges?.length > 0 && (
              <div className="bg-white rounded-2xl p-6 shadow-md">
                <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                  <Users className="text-[#605DEC]" size={20} />
                  ...
                  {data.judges.map((judge: any, index: number) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className="font-medium text-gray-800">{judge.username}</p>
                      </div>
                    );
                  })}
                </div>
