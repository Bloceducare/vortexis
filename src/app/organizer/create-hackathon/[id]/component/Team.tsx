          ...
          <div className="flex gap-6 flex-wrap">
            <div className="w-full md:w-[45%]">
              ...
              <div className="w-full rounded-2xl border border-[#C5C6CC] px-4 py-3 outline-none">
                <input
                  type="text"
                  placeholder="Enter minimum team members e.g(1 individual)"
                  name="min_team_size"
                  value={min_team_size}
            ...
            <div className="w-full md:w-[45%]">
              ...
              <div className="w-full rounded-2xl border border-[#C5C6CC] px-4 py-3 outline-none">
                <input
                  type="text"
                  placeholder="Enter maximum team members e.g(6 members)"
                  name="max_team_size"
                  value={max_team_size}
          ...
          <div className="mt-10">
            <div className="space-y-4">
              {notifications.map((notif, idx) => (
                <div
                  key={idx}
                  className="flex items-center justify-between w-2/5 xl:w-[25%] pb-3"
                >
