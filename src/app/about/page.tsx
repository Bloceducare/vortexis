    ...
    >
      ...
      <div className="text-sm opacity-60">{stat.label}</div>
        ...
        <motion.div
          ...
          className="bg-white dark:bg-gray-800 rounded-3xl p-12 shadow-xl border border-gray-100 dark:border-gray-700 mb-16"
        >
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl font-bold text-title mb-4">Our Mission</h2>
        ...
        <motion.div
          ...
          className="mt-20 bg-gradient-to-r from-purple-600 to-blue-600 rounded-3xl p-12 text-center shadow-2xl"
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-8 py-4 bg-white text-purple-600 rounded-xl font-semibold hover:bg-gray-100 transition-all shadow-lg cursor-pointer"
