  ...
  return (
    <section className="relative w-full  bg-gradient-to-br from-[#E0D9FB] via-[#D8DBFF] to-[#F4F4FF] overflow-hidden">
      ...
      >
        <motion.h1
          variants={fadeUp}
          className="text-2xl mt-5 md:text-4xl lg:text-5xl xl:text-6xl font-bold text-[#212121] mb-3 md:mb-4"
        >
          Run. Join. Win.
        </motion.h1>
        ...
        <motion.h2
          variants={fadeUp}
          className="text-xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold text-[#212121] mb-4 md:mb-6 lg:mb-6"
        >
        ...
        <motion.p
          variants={fadeUp}
          className="text-sm md:text-lg lg:text-xl text-[#212121] font-medium leading-relaxed max-w-xs md:max-w-2xl lg:max-w-3xl mx-auto mb-6 md:mb-8 lg:mb-10 lg:mt-2 px-2 md:px-0"
        >
